...
constexpr auto k_colours = [] {
    ...
    for (auto const i : Range(ToInt(Colour::Count))) {
        switch (Colour(i)) {
            ...
            case Colour::Highlight: result[i] = Hsla(k_highlight_hue, 70, 44, 100); break;
...
constexpr f32 k_settings_lhs_width = 190.0f;
constexpr f32 k_settings_small_gap = 3.0f;
constexpr f32 k_settings_medium_gap = 10.0f;
constexpr f32 k_settings_large_gap = 28.0f;
constexpr f32 k_settings_icon_button_size = 16.0f;
constexpr f32 k_menu_item_padding_x = 8;
constexpr f32 k_menu_item_padding_y = 3;
constexpr f32 k_notification_panel_width = 300;
constexpr f32 k_intall_dialog_width = 400;
constexpr f32 k_intall_dialog_height = 300;
