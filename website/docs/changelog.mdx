...
- Remove the drag-to-change behaviour from menu controls. It was more annoying than useful: too easy to accidentally change values. Click to open the menu or use the arrow buttons instead
