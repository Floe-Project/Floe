...
- Add LUFS meter to top panel
- Add a peak-hold line to all peak meters: it marks the highest level reached, holds there for a moment, then falls back
- Change the peak meter ranges and add min/max markers: top panel meter -60dB to +10dB becomes -36dB to +6dB with markers every 6dB, layer mixer meter -60dB to +10dB becomes -60dB to +12dB with markers every 12dB
